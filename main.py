...
env = gym.make('MountainCar-v0') #создали виртуальное окружение

LENGTH_CHROM = 200 # длина хромосомы
...
creator.create("Individual", list, fitness=creator.FitnessMin) #класс для хранения хромосомы индивидуума
